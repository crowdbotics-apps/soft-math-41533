"""
Django settings for soft_math_41533 project.
...
ROOT_URLCONF = 'soft_math_41533.urls'
...
WSGI_APPLICATION = 'soft_math_41533.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_math_41533 API",
    "DESCRIPTION": "API documentation for soft_math_41533 App",
    "VERSION": "v1",
}
